...
const fetchWeather = async (cityName: string) => {
  ...
  // Although we're fetching data from the owm API...
  // This is a POST request because we're visiting the same
  // URL to get city data, but getting different data each time.
  ...
  // Note: It's OUR responsibility to correctly format weatherData so that the two helper functions below work as expected.
  // TODO: Implement weatherData so that renderCurrentWeather functions as expected.
